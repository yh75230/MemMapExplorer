...
MemMap Explorer 是一个 Windows 桌面应用，用于探索 **磁盘占用情况** 以及从 linker MAP 文件、ELF 二进制和已保存分析结果中导入的 **内存布局分析数据**。
...
MemMap Explorer 适合用于可视化分析大型结构化数据，主要用途包括：

- 通过目录树 + Treemap 分析磁盘空间占用
- 导入并查看 MAP / ELF 分析结果
...
![Animated preview](20260604-114834.gif)

#### 界面截图

![Preview 1](20260604-145817.jpg)

![Preview 2](20260604-151805.jpg)

![Preview 3](20260604-152350.jpg)

![Preview 4](20260604-152515.jpg)
...
MemMap Explorer is a Windows desktop application for exploring **disk usage** and **imported memory-layout analysis data** from linker MAP files, ELF binaries, and saved analysis results.
...
MemMap Explorer helps you inspect and navigate large structured datasets visually.

It can be used to:

- analyze directory and file space usage with a tree + treemap workflow
