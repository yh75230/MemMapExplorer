...
namespace wds
{
    ...
    inline constexpr auto strUninstall   = L"Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\MemMapExplorer";
    ...
    inline constexpr auto strWinDirStat = L"MemMap Explorer";
