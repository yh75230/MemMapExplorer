...
LPCWSTR COptions::OptionsRegionSelect = L"RegionSelect";
...
Setting<RECT> COptions::RegionSelectWindowRect(OptionsRegionSelect, L"WindowRect");
...
void COptions::PostProcessPersistedSettings()
{
    ...
    SanitizeRect(RegionSelectWindowRect.Obj());
